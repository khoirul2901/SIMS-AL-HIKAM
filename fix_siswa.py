...
bad_str = """                  </table>
                ...
                <div class="kartu-qr">
                  <img src="https://quickchart.io/qr?text=${s.nis}&size=60&margin=1" alt="QR" style="width: 50px; height: 50px; border: 1px solid #e2e8f0; border-radius: 4px; padding: 2px; background: white;" />
                </div>
              </div>
            </div>
